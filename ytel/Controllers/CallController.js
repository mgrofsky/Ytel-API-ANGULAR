...
angular.module('Ytel')
    ...
    function CallController($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
             ...
             * parameters will be sent here once the call is
             * finished.
             * @param {HttpActionEnum|null} input['statsCallBackMethod'] [Optional] Specifies the HTTP method used
             * to request the required StatusCallBackUrl
             * once call connects.
             *
             * @return {promise<String>}
             */
             ...
             * @return {promise<String>}
             */
            viewCallDetail: function (callSid, responseType) {
                // Assign default values
                ...
                if (callSid === null || callSid === undefined) {
                    _deffered.reject({
                        errorMessage: 'The parameter `callSid` is a required parameter and cannot be null.',
                        errorCode: -1
                    });
                    _missingArgs = true;
                }
                ...
                //prepare query string for API call
                var _baseUri = Configuration.getBaseUri();
                var _queryBuilder = _baseUri + '/calls/viewcalldetail.{ResponseType}';
