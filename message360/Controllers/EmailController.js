...
angular.module('Message360')
    ...
    function EmailController($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
             ...
             * @param {string|null} input['attachment'] [Optional] File to be attached.File must be less than 7MB.
             *
             * @return {promise<String>}
             */
             ...
             *
             * @param {array}  input    Array with all options for search
             * @param {string} input['email'] Email that was marked invalid
             * @param {string} input['responseType'] Json or xml
             *
             * @return {promise<String>}
             */
