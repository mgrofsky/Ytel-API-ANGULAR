...
angular.module('YtelAPILib')
    ...
    function SMSController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
             ...
             */
            createSmsViewdetailsms: function (messageSid) {
             ...
             * @return {promise<String>}
             */
            createSmsViewsms: function (messageSid) {
             ...
             * @return {promise<String>}
             */
            createSmsGetinboundsms: function (input) {
             ...
             * @return {promise<String>}
             */
            createSmsListsms: function (input) {
                // Assign default values
                input = input || {};
             ...
             * @return {promise<String>}
             */
            createSmsSendsms: function (input) {
                // Assign default values
                input = input || {};
